                   ...
                   TimedDoubleSeq &data_in)
{
    ...
    fprintf(fp, "%lf %lf %lf %lf %lf\n",
            now - beginTime,
            data_in.data[0], data_in.data[1],
            data_in.data[2], data_in.data[3]);
}

void writePMallet(InPort<TimedDoubleSeq> &data_inIn, TimedDoubleSeq &data_in) {
    writeLogData2(fpPMlt, data_inIn, data_in); // for 2 players
}
...
{
    static int numLog = 0;
    const char basename[] = "/tmp/HkyLogs";
