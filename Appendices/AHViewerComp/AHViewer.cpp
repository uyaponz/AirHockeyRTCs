...
static const int winW = 412;
static const int winH = 662;
static const int ofsX = 5;
static const int ofsY = 5;
...
RTC::ReturnCode_t AHViewer::onExecute(RTC::UniqueId ec_id)
{
    ...
    CvPoint2D64f rMlt = cvPoint2D64f(m_rMalletXY_in.data[0], m_rMalletXY_in.data[1]);
